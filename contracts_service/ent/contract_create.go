...
func (cc *ContractCreate) SetVendorID(i int) *ContractCreate {
	cc.mutation.SetVendorID(i)
	return cc
}
...
func (cc *ContractCreate) SetNillableStatus(c *contract.Status) *ContractCreate {
	if c != nil {
		cc.SetStatus(*c)
	}
	return cc
...
func (cc *ContractCreate) SetNillableStartDate(t *time.Time) *ContractCreate {
	if t != nil {
		cc.SetStartDate(*t)
	}
	return cc
...
func (cc *ContractCreate) SetNillableEndDate(t *time.Time) *ContractCreate {
	if t != nil {
		cc.SetEndDate(*t)
	}
	return cc
...
func (cc *ContractCreate) SetTotalAmount(i int) *ContractCreate {
	cc.mutation.SetTotalAmount(i)
	return cc
}

// SetNillableTotalAmount sets the "total_amount" field if the given value is not nil.
func (cc *ContractCreate) SetNillableTotalAmount(i *int) *ContractCreate {
	if i != nil {
		cc.SetTotalAmount(*i)
	}
	return cc
...
func (cc *ContractCreate) SetRemainingAmount(i int) *ContractCreate {
	cc.mutation.SetRemainingAmount(i)
	return cc
}

// SetNillableRemainingAmount sets the "remaining_amount" field if the given value is not nil.
func (cc *ContractCreate) SetNillableRemainingAmount(i *int) *ContractCreate {
	if i != nil {
		cc.SetRemainingAmount(*i)
	}
	return cc
}
...
func (cc *ContractCreate) defaults() {
	...
	if _, ok := cc.mutation.TotalAmount(); !ok {
		v := contract.DefaultTotalAmount
		cc.mutation.SetTotalAmount(v)
	}
	if _, ok := cc.mutation.RemainingAmount(); !ok {
		v := contract.DefaultRemainingAmount
		cc.mutation.SetRemainingAmount(v)
	}
...
func (cc *ContractCreate) check() error {
	if _, ok := cc.mutation.VendorID(); !ok {
		return &ValidationError{Name: "vendor_id", err: errors.New(`ent: missing required field "Contract.vendor_id"`)}
	}
	if _, ok := cc.mutation.Status(); !ok {
	...
	if _, ok := cc.mutation.TotalAmount(); !ok {
		return &ValidationError{Name: "total_amount", err: errors.New(`ent: missing required field "Contract.total_amount"`)}
	}
	if _, ok := cc.mutation.RemainingAmount(); !ok {
		return &ValidationError{Name: "remaining_amount", err: errors.New(`ent: missing required field "Contract.remaining_amount"`)}
	}
	if _, ok := cc.mutation.CreatedAt(); !ok {
...
func (cc *ContractCreate) createSpec() (*Contract, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.TotalAmount(); ok {
