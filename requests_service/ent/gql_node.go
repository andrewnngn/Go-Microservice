...
func (r *Request) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(r.ContractID); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(r.VendorID); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(r.ContractorID); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(r.Amount); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(r.CollectionDate); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "time.Time",
