...
import (
	"errors"
	"fmt"
	_ "github.com/techvify-oliver/protoserver/generated"
	...
	grpcServer "golang-boilerplate/internal/grpc/server"
...
func init() {
	...
	go func() {
		grpcServer.StartServer(db, configs.Port.GrpcServerPort)
	}()
