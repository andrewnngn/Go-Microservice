...
var (
	...
	// GroupOrderFieldAddress orders Group by address.
	GroupOrderFieldAddress = &GroupOrderField{
		field: group.FieldAddress,
		toCursor: func(gr *Group) Cursor {
			return Cursor{
				ID:    gr.ID,
				Value: gr.Address,
	...
	// GroupOrderFieldEmail orders Group by email.
	GroupOrderFieldEmail = &GroupOrderField{
		field: group.FieldEmail,
		toCursor: func(gr *Group) Cursor {
			return Cursor{
				ID:    gr.ID,
				Value: gr.Email,
	...
	// GroupOrderFieldRole orders Group by role.
	GroupOrderFieldRole = &GroupOrderField{
		field: group.FieldRole,
		toCursor: func(gr *Group) Cursor {
			return Cursor{
				ID:    gr.ID,
				Value: gr.Role,
...
func (f *GroupOrderField) UnmarshalGQL(v interface{}) error {
	...
	case "ADDRESS":
		*f = *GroupOrderFieldAddress
	case "EMAIL":
		*f = *GroupOrderFieldEmail
	case "ROLE":
		*f = *GroupOrderFieldRole
	case "CREATED_AT":
