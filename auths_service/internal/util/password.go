// What is this file about: wrapper of Go's argon2 package.
// Why I use this in my project instead of other password hashing package: I see a tutorial about this and I love it.
// Used for pet project only, not for production. Bcrypt could be a better choice for production.
package util
...
type Params struct {
	Memory      uint32 // The amount of memory used by the algorithm (kilobytes)
